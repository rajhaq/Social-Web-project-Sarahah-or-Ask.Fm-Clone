                  ...
                  <div class="col-md-12 mb-5">
                        ...
                        <div class="card card-cascade wider reverse">
                            ...
                            <div class="card-body text-center ">
                                <h2>
                                <!--Added text-->
                                <div class="added-text"> <i class="fa fa-question-circle" ></i> Question: {{ $newsfeeds->question_body }}</div>
                                <div class="added-text"> <i class="fa fa-mail-reply-all" aria-hidden="true"></i> Answer: {{ $newsfeeds->answer_body }}</div>   
                                </h2>
